...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coauthored_posts: Schema.Attribute.Relation<'manyToMany', 'api::post.post'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    institution: Schema.Attribute.String;
    lattes_url: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::author.author'
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categorias dos posts do blog';
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Posts do blog GIFLABS';
    displayName: 'Post';
    pluralName: 'posts';
    singularName: 'post';
  };
  ...
  attributes: {
    ...
    language: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pt-BR'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    series_part: Schema.Attribute.Integer;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Projetos do GIFLABS relacionados aos posts';
    displayName: 'Project';
    pluralName: 'projects';
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Tags para organiza\u00E7\u00E3o dos posts';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
