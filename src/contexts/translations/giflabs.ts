export const giflabsTranslations = {
  pt: {
    "giflabs": {
      ...
      "hero": {
        "title": "GIFLABS",
        "description": "Produção e disseminação de conteúdos audiovisuais focados em arte, filosofia e tecnologia.",
        "cta_main": "Inscreva-se no Canal",
        "cta_secondary": "Sobre o Canal"
      },
      "content": {
        "title": "Diálogos sobre Arte, Filosofia e Tecnologia",
        "description_1": "O canal GIFLABS é uma iniciativa vinculada ao GIF Labs dedicada à produção e disseminação de conteúdos audiovisuais focados em arte, filosofia e tecnologia. Com ênfase em vídeos de entrevistas, cursos, podcasts e debates temáticos, o canal promove o diálogo crítico e o aprofundamento das principais questões contemporâneas nesses campos.",
        "description_2": "Voltado para pesquisadores, estudantes e público interessado, GIFLABS oferece uma plataforma estruturada para a troca de conhecimento entre especialistas nacionais e internacionais, abordando temas como inteligência artificial, ética digital, práticas artísticas digitais e governança descentralizada por meio das DAOs.",
